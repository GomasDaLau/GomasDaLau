...
// Attach input event listeners to validate inputs in real-time
document.getElementById('user-name').addEventListener('input', checkInputs);
document.getElementById('user-address').addEventListener('input', checkInputs);
document.getElementById('user-phone').addEventListener('input', checkInputs);
document.getElementById('user-country').addEventListener('input', checkInputs_portes);
document.getElementById('user-postalcode').addEventListener('input', checkInputs);
document.getElementById('user-email').addEventListener('input', checkInputs);

// Enable/disable the download button based on input validation
